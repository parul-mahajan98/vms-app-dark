...
import {addVehicle,updateVehicle} from '../services/vehicle/vehicleActions';

class VehicleObject extends Component {
    constructor(props) {
        super(props);
    ...
    updateVehicle = (e) => {
        ...
        this.props.updateVehicle(vehicle.id,vehicle);
        setTimeout(()=>{
        if (this.props.vehicleObject.vehicle !== null) {
                        this.setState({ "show": true });
                        setTimeout(() => this.setState({ "show": false }), 1000);
...
export default connect(mapStateToProps,mapDispatchToProps)(VehicleObject);